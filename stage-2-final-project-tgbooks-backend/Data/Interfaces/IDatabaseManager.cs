...
namespace stage_2_final_project_tgbooks_backend.Data.Interfaces
{
    public interface IDatabaseManager
    {
        ...
        Task<ICollection<Book>> GetBooksPageAsync(string? title, int? categoryId, bool? onSale, int pageNumber, int pageSize);
        ...
        Task<CartItem> AddItemToCartAsync(int bookId, int userId, int bookQuantity);
